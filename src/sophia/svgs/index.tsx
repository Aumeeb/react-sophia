...
export const Field = (props: SVGBlockSize) => (
  <svg
    ...
    viewBox="0 0 16 16">
    <path
      style={{opacity: 0, fill: '#2d2d30'}}
      d="M16 16H0V0h16v16z"
      id="canvas"
    />{' '}
    <path
      style={{fill: '#2d2d30'}}
      d="M0 10.736V4.5L9 0l7 3.5v6.236l-9 4.5-7-3.5z"
      id="outline"
    />
    <path
      style={{fill: '#75beff'}}
      d="M9 1L1 5v5l6 3 8-4V4L9 1zM7 6.882L3.236 5 9 2.118 12.764 4 7 6.882z"
      id="iconBg"
    />
    <path
      style={{fill: '#2b282e'}}
      d="M9 2.118L12.764 4 7 6.882 3.236 5 9 2.118z"
      id="iconFg"
    />
  </svg>
)
...
export const Array = (props: SVGBlockSize) => (
  <svg
    ...
    <path
      style={{fill: '#2d2d30'}}
      d="M14.414 1L16 2.586v5.828L14.414 10H10v3.416L8.414 15H1.586L0 13.416v-5.83L1.586 6H6V2.586L7.586 1h6.828z"
      id="outline"
    />
    <path
      style={{fill: '#2b282e'}}
      d="M2 13h6V8H2v5zm1-4h4v1H3V9zm0 2h4v1H3v-1zm11-5V3H8v3h.414L9 6.586V6h4v1H9.414l.586.586V8h4V6zm-1-1H9V4h4v1z"
      id="iconFg"
    />
    <path
      style={{fill: '#e8ab53'}}
      d="M3 11h4.001v1H3v-1zm0-1h4.001V9H3v1zm6-2v5l-1 1H2l-1-1V8l1-1h6l1 1zM8 8H2v5h6V8zm1-2l1 1h3V6H9zm0-1h4V4H9v1zm5-3H8L7 3v3h1V3h6v5h-4v1h4l1-1V3l-1-1z"
      id="iconBg"
    />
  </svg>
)
